...
def main():
    ...
    skill = AgentSkill(
        ...
        description="Solves coding problems for BigCodeBench benchmark",
        tags=["benchmark", "bigcodebench", "python"],
        examples=[],
    )

    agent_card = AgentCard(
        name="purple_code_agent",
        description="Expert code generation agent for benchmark evaluation",
